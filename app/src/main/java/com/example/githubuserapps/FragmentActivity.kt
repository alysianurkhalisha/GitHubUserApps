...
class FragmentActivity : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val mainViewModel: ViewModel = ViewModelProvider(this@FragmentActivity, ViewModelProvider.AndroidViewModelFactory(requireActivity().application)).get(ViewModel::class.java)
        if (user != null) {
        }
